use std::{fmt::{Display, Debug}, num::ParseIntError};
...
impl Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Error::InvalidNumber(msg, num, line) => write!(f, "Invalid number {} at line {} wit error {}", num, line, msg),
            ...
            Error::InvalidByte(byte, line) => write!(f, "Invalid byte at line {}: {} is bigger than 0xFF", line, byte),
            Error::InvalidNibble(nibble, line) => write!(f, "Invalid nibble at line {}: {} is bigger than 0xF", line, nibble),
